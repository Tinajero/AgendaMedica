...
<body>
	<a href="#show-domicilio" class="skip" tabindex="-1"><g:message
			...
			<g:if test="${domicilio?.localidad}">
				<li class="fieldcontain"><span id="localidad-label"
					...
					class="property-value" aria-labelledby="localidad-label"><g:fieldValue
							bean="${domicilio}" field="localidad" /></span></li>
			</g:if>

			<g:if test="${domicilio?.municipio}">
				<li class="fieldcontain"><span id="municipio-label"
					class="property-label"><g:message
							code="domicilio.municipio.label" default="Municipio" /></span> <span
					class="property-value" aria-labelledby="municipio-label"><g:fieldValue
							bean="${domicilio}" field="municipio" /></span></li>
			</g:if>

			<g:if test="${domicilio?.numeroExterior}">
				<li class="fieldcontain"><span id="numeroExterior-label"
					class="property-label"><g:message
							code="domicilio.numeroExterior.label" default="Numero Exterior" /></span>

					<span class="property-value" aria-labelledby="numeroExterior-label"><g:fieldValue
							bean="${domicilio}" field="numeroExterior" /></span></li>
			</g:if>

			<g:if test="${domicilio?.numeroInterior}">
				<li class="fieldcontain"><span id="numeroInterior-label"
					class="property-label"><g:message
							code="domicilio.numeroInterior.label" default="Numero Interior" /></span>

					<span class="property-value" aria-labelledby="numeroInterior-label"><g:fieldValue
							bean="${domicilio}" field="numeroInterior" /></span></li>
			</g:if>

		</ol>
		<g:form url="[resource:domicilio, action:'delete']" method="DELETE">
			<fieldset class="buttons">
				<g:link class="edit" action="edit" resource="${domicilio}">
