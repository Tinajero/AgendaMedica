			...
			<ol class="property-list cita">
				...
				<li class="fieldcontain">
					<span id="hora-label" class="property-label"><g:message code="cita.hora.label" default="Hora" /></span>
						...
						<span class="property-value" aria-labelledby="hora-label"><g:fieldValue bean="${cita}" field="hora"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${cita?.minuto}">
				<li class="fieldcontain">
					<span id="minuto-label" class="property-label"><g:message code="cita.minuto.label" default="Minuto" /></span>
					
						<span class="property-value" aria-labelledby="minuto-label"><g:fieldValue bean="${cita}" field="minuto"/></span>
